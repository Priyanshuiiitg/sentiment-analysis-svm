...
def preprocess_text(text):
    # Convert to lowercase and remove special characters and digits
...
# Use TfidfVectorizer with stop words removal and n-gram range (1, 2)
...
cv_scores = cross_val_score(best_svm, X_train, train_labels, cv=3)
...
# Calculating TP, TN, FP, FN from confusion matrix
TP = conf_matrix[1, 1]
TN = conf_matrix[0, 0]
FP = conf_matrix[0, 1]
FN = conf_matrix[1, 0]
